...
// Data merged from "11- Biochemistry MCQs Amino Acid PROTEINS.pdf" and "Protein Biochemistry kasr.pdf" (Total 56 unique questions after deletion and correction).
window.QUIZ_APP_DATA.questions["BIO103-amino"] = [
    ...
    },
    {
        ...
        correctAnswer: "c",
        explanation: "The **alpha helix** is a secondary structure stabilized by **intrachain hydrogen bonds** between the carbonyl oxygen ({C=O}) of one amino acid and the **alpha-amino** hydrogen ({N-H}) of an amino acid four residues away."
    },
    {
    ...
    // Original Question 8 has been deleted as requested.
    {
        question: "8. Which amino acid can form disulphide bonds?",
    ...
    // Unique Questions from "11- Biochemistry MCQs Amino Acid PROTEINS.pdf" (New Q9-Q34)
    {
        question: "9. The most important function of proteins in our body is:",
    ...
    {
        question: "10. Aliphatic non polar amino acids are exemplified by:",
    ...
    {
        question: "11. The tertiary structure of a protein is:",
    ...
    {
        question: "12. The major functions of proteins in the human body include:",
    ...
    {
        question: "13. Non standard amino acids in protein structure include:",
    ...
    {
        question: "14. The pancreatic enzyme not involved in protein digestion is:",
        answers: { a: "Carboxypeptidase", b: "Trypsin", c: "Lipase", d: "Elastase" },
        correctAnswer: "c",
        explanation: "**Lipase** digests lipids (fats), not proteins."
    },
    {
        question: "15. In the polypeptide chain, the peptide bond:",
    ...
    {
        question: "16. Denaturation of a protein:",
    ...
    {
        question: "17. The amino acids with positively charged side chains include:",
    ...
    {
        question: "18. Which of the following is an imino acid?",
    ...
    {
        question: "19. The non-essential amino acid, which has a sulfur containing group is:",
    ...
    {
        question: "20. Amino acid containing an amide group is:",
        answers: { a: "Aspartate", b: "Glutamine", c: "Lysine", d: "Tyrosine" },
        correctAnswer: "b",
        explanation: "**Glutamine** has an amide group in its side chain ({CONH}_2)."
    },
    {
        question: "21. The amino acid involved in the biosynthesis of urea is:",
    ...
    {
        question: "22. One of the following is an essential amino acid:",
        answers: { a: "Alanine", b: "Glycine", c: "Tryptophan", d: "Serine" },
        correctAnswer: "c",
        explanation: "**Tryptophan** is one of the nine essential amino acids."
    },
    {
        question: "23. Which of the following is a gamma amino acid?",
    ...
    {
        question: "26. The amino acid that lacks D and L stereoisomers is:",
        answers: { a: "Alanine", b: "Glycine", c: "Proline", d: "Serine" },
        correctAnswer: "b",
    ...
    {
        question: "27. Amino acids are linked together by:",
    ...
    {
        question: "28. All the below mentioned amino acids can participate in hydrogen bonding Except:",
    ...
    {
        question: "29. The primary structure of protein represents:",
    ...
    {
        question: "30. Tertiary structure is the:",
    ...
    {
        question: "31. Which of the following is NOT an essential amino acid?",
    ...
    {
        question: "32. Which of the following is a branched amino acid?",
    ...
    {
        question: "33. The two amino acids that contain sulfur atoms are:",
    ...
    // Unique Questions from "Protein Biochemistry kasr.pdf" (New Q35-Q56)
    {
        question: "34. Serine and threonine are polar amino acids due to:",
        ...
        correctAnswer: "a",
        explanation: "Both Serine and Threonine are polar because they possess a **hydroxyl ({OH}) group** in their side chain."
    },
    {
        question: "35. Amino acids with hydroxyl groups are:",
        answers: { a: "Serine and alanine", b: "Alanine and valine", c: "Serine and threonine", d: "Valine and isoleucine" },
        correctAnswer: "c",
        explanation: "**Serine** and **Threonine** contain a hydroxyl ({OH}) group."
    },
    {
        question: "36. An amino acid which contains a disulphide bond is:",
    ...
    {
        question: "37. All of the following are polar amino acids Except:",
    ...
    {
        question: "38. Acidic amino acids include:",
    ...
    {
        question: "39. Which of the following is known as half-cystine residue?",
    ...
    {
        question: "40. The alpha carbon of an amino acid is attached to:",
    ...
    {
        question: "42. The {pI} (isoelectric point) of acidic amino acids is:",
        answers: { a: "Less than {pH} 7.0", b: "More than {pH} 7.0", c: "Equal to {pH} 7.0", d: "None of the above" },
        correctAnswer: "a",
        explanation: "Acidic amino acids require a **lower {pH} (acidic)** to neutralize the charge, thus the {pI} is **less than {pH} 7.0**."
    },
    {
        question: "43. The {pI} of basic amino acids is:",
        answers: { a: "Less than {pH} 7.0", b: "More than {pH} 7.0", c: "Equal to {pH} 7.0", d: "None of the above" },
        correctAnswer: "b",
        explanation: "Basic amino acids require a **higher {pH} (alkaline)** to neutralize the charge, thus the {pI} is **more than {pH} 7.0**."
    },
    {
        question: "44. In D amino acids, the alpha amino group is on the:",
    ...
    {
        question: "46. The weakest bond in protein structure is:",
    ...
    {
        question: "47. Quaternary structure is stabilized by:",
    ...
    {
        question: "48. Alpha amino acids are called alpha because:",
        ...
        correctAnswer: "b",
        explanation: "They are called alpha amino acids because the amino group ({NH}_2) is bonded to the **alpha carbon**."
    },
    {
        question: "49. Which of the following is NOT a function of proteins?",
    ...
    {
        question: "50. Histidine is considered a basic amino acid because of:",
    ...
    {
        question: "51. The precursor of thyroid hormones is:",
        answers: { a: "Tryptophan", b: "Tyrosine", c: "Serine", d: "Methionine" },
        correctAnswer: "b",
        explanation: "The amino acid **Tyrosine** is the precursor for the synthesis of thyroid hormones {(T3/T4)}."
    },
    {
        question: "52. An amino acid which can be converted to catecholamines is:",
    ...
    {
        question: "53. Non-protein amino acid is:",
    ...
    {
        question: "54. Sulphur containing amino acids are:",
    ...
    {
        question: "55. In a tripeptide, the peptide bond:",
